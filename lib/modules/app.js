...
import {ModalView, Widget} from './widgets.js';
...
export class App extends Widget {
    ...
    constructor(props=null) {
        ...
        /** @type {Widget} Main widget container*/
...
//        this._needsLayout = false;
        ...
        this._modalWidgets = [];
        /** @type {number} Size of a (assumed square) pixel in logical units (all measurements in the engine are in logical units)*/
        this.pixelSize = 1;
        /** @type {boolean} Flag indicating whether to round tiles to an integer multiple (useful to pixel art based UIs)*/
        this.integerTileSize = false;
        /** @type  {boolean} Flag indicating whether exactDimension will be used if true, or rounded to nearest integer if false*/
        this.exactDimensions = false;
        /** @type {number} Preferred width of canvas in square tiles*/
        this.prefDimW = 32;
        /** @type {number}  Preferred width of canvas in square tiles*/
        this.prefDimH = 16;
        ...
        /** @type {number} Initialize size of a tiles that (in logical units) maximizes use of available space*/
    ...
    *iterByPropertyValue(property, value) {
    ...
    /**
     * Returns the position in tile units converted to pixels.
     ...
     */
    toLocal(pos) {
        return [(pos[0]-this.offsetX-this.shakeX)/this.tileSize, (pos[1]-this.offsetY-this.shakeY)/this.tileSize];//        return pos;
    }
    /**
     ...
     * potentiall leaving the canvas much smaller than the window size 
     * @param {number} scale; 
     */

 ...
 */
export class App extends widgets.Widget {
    /**
    ...
    /** @type {widgets.Rules} */
    static rules = new widgets.Rules();
    /** @type {Map<string, widgets.Resource>} */
    ...
    static classes = {
        ...
        'BasicButton':[widgets.BasicButton, ''],
        'TextInput':[widgets.TextInput, ''], 
        'CheckBox':[widgets.CheckBox, ''],
        'Slider':[widgets.Slider, ''],
        'ImageWidget':[widgets.ImageWidget, ''], 
        'BoxLayout':[widgets.BoxLayout, ''],
        'GridLayout':[widgets.GridLayout, ''], 
        'ScrollView':[widgets.ScrollView, ''], 
        'ModalView':[widgets.ModalView, ''],
        'Notebook': [widgets.Notebook, ''],
        'TabbedNotebook': [widgets.TabbedNotebook, ''],
        'SpriteWidget': [sprites.SpriteWidget, ''],
        'TileMap': [sprites.TileMap, ''],
        'LayeredTileMap': [sprites.LayeredTileMap, ''],
    };
    /**
     * 
     * @param {string} name 
    ...
    constructor(props=null) {
        ...
        //@ts-ignore
        window.app = this;
        /** @type {widgets.EventManager} */
        this._eventManager = new widgets.EventManager();
        /** @type {string} */
        this.id = 'app';
        /** @type {number} */
        ...
        /** @type {widgets.Widget} The baseWidget object*/
        this._baseWidget = new widgets.Widget({hints:{x:0, y:0, w:1, h:1}});
        this._baseWidget.parent = this;
        /** @type {Array<widgets.ModalView>} Container for modal widgets*/
        this._modalWidgets = [];
        /** 
     ...
     * @param {widgets.ModalView} modal - the instance of the ModalView object to add
     */
    addModal(modal) {

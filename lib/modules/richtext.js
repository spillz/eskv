 ...
 * @param {CanvasRenderingContext2D|OffscreenCanvasRenderingContext2D|OffscreenCanvasRenderingContext2D|OffscreenCanvasRenderingContext2D} ctx
...
function wrapRich(ctx, atoms, baseSize, fontName, maxWidth) {
    /**@type {{text:string, width:number, sizePx:number, fg:string|null, bg:string|null, a:number}[][]} */

...
export class TileMap extends Widget {
	...
	*iterTypesInRange(pos, types, radius, blocker_types=null) {
		for(var pos0 of this.iterInRange(pos, radius)){
			if(blocker_types !== null && this.hasTypesInBetween(pos, pos0, blocker_types)) continue;
...
export class LayeredTileMap extends TileMap {
    ...
    on_alphaLayer(e,o,v) {
        this._aLayer = this.alphaLayer? this._layerData[this.alphaLayer]: null;
    }
    on_visibilityLayer(e,o,v) {
        this._vLayer = this.visibilityLayer? this._layerData[this.visibilityLayer]: null;
    }
    serialize() {
        const data = {};
        const layerCopy = [];

        ...
        if(this.collide(r)) {
            ...
            if(this.uiZoom && (touch.nativeEvent instanceof TouchEvent) && touch.nativeEvent.touches.length==2) {
                ...
                if(this._lastDist != null) {
                    ...
                    let pos0l = this.toChild(pos0);
                    let pos1l = this.toChild(pos1);
                    let posctr = [(pos0l[0]+pos1l[0])/2, (pos0l[1]+pos1l[1])/2];
                    let loc = new Vec2(posctr);
                    ...
                    let pos0m = this.toChild(pos0);
                    let pos1m = this.toChild(pos1);
                    let posctrm = [(pos0m[0]+pos1m[0])/2, (pos0m[1]+pos1m[1])/2];
                    let moc = new Vec2(posctrm);

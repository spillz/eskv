...
export class ScrollView extends Widget {
    ...
    on_focus_direction(event, object, data) {
        ...
        if (!this.canFocus || !inputHandler.isDescendantOf(inputHandler.focusedWidget, this)) return false;
        if (inputHandler.moveFocusWithin(this, direction, false)) return true;
        inputHandler.focusWidget(this);
        return true;
    }
    /**

    ...
    *iter(recursive = true, inView = true) {
    ...
    on_wheel(event, object, touch) {
        ...
        if (this.uiZoom && app.inputHandler.isKeyDown("Control")) {
            ...
            this.scrollX = (this.scrollableW == 0 && !this.unboundedW) ? 0 : (sx - this.w / this.zoom / 2) / this.scrollableW;
            this.scrollY = (this.scrollableH == 0 && !this.unboundedH) ? 0 : (sy - this.h / this.zoom / 2) / this.scrollableH;

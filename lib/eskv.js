...
import {EventSink, Widget, WidgetAnimation, Resource, Label, Button, BasicButton, ToggleButton,
        CheckBox, Slider, TextInput, ImageWidget, 
        GridLayout, BoxLayout, ScrollView, ModalView, Notebook, TabbedNotebook} from './modules/widgets.js';
...
export {Vec2, Rect, App, Resource, EventSink, WidgetAnimation, 
